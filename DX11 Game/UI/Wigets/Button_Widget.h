...
public:
    ...
    bool Function( std::string text, std::vector<ButtonTexType> ButtonText, DirectX::XMFLOAT2 size, DirectX::XMFLOAT2 pos, XMVECTORF32 textColour, MouseData MData );
private:
    Sprite _Background;
...
template<typename ButtonTexType>
inline bool Button_Widget<ButtonTexType>::Function( std::string text, std::vector<ButtonTexType> ButtonText, DirectX::XMFLOAT2 size, DirectX::XMFLOAT2 pos, XMVECTORF32 textColour, MouseData MData )
{
