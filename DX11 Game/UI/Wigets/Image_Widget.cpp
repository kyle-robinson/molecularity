...
Image_Widget::Image_Widget(string texture, DirectX::XMFLOAT2 size, DirectX::XMFLOAT2 pos)
{
...
bool Image_Widget::Function(string texture, DirectX::XMFLOAT2 size, DirectX::XMFLOAT2 pos)
{
