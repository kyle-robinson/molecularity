...
std::string UI::ConvertFromUnsignedCharToString( unsigned char input )
{
	...
	case VK_SHIFT:
	case VK_LSHIFT:
	case VK_RSHIFT: text = "Shift"; break;
	case VK_CONTROL: text = "Ctrl"; break;

		// Alt
	case VK_MENU: text = "alt"; break;

	case VK_PAUSE: text = "Pause"; break;
	case VK_ESCAPE: text = "ESC"; break;
	case VK_CAPITAL: text = "CAPS LOCK"; break;
	case VK_BACK: text = "BACKSPACE"; break;
	case VK_TAB: text = "Tab"; break;

		// Page Up
	case VK_PRIOR: text = "page Up"; break;
		// Page Down
	case VK_NEXT: text = "page Down"; break;

	case VK_END: text = "End"; break;
	case VK_HOME: text = "Home"; break;
	case VK_SELECT: text = "Select"; break;
	case VK_INSERT: text = "Ins"; break;
	case VK_DELETE: text = "Del"; break;
	case VK_HELP: text = "Help"; break;
	case VK_SCROLL: text = "Scr Lock"; break;
	case VK_CLEAR: text = "Clear"; break;

		// Arrow keys
	case VK_UP: text = "Up Arrow"; break;
	case VK_DOWN: text = "Down Arrow"; break;
	case VK_LEFT: text = "Left Arrow"; break;
	case VK_RIGHT: text = "Right Arrow"; break;
	...
	case VK_F12: text = "F12"; break;
		...
		// Numpad
	case VK_NUMLOCK: text = "Numlock"; break;
	case VK_NUMPAD0: text = "Numpad 0"; break;
	case VK_NUMPAD1: text = "Numpad 1"; break;
	case VK_NUMPAD2: text = "Numpad 2"; break;
	case VK_NUMPAD3: text = "Numpad 3"; break;
	case VK_NUMPAD4: text = "Numpad 4"; break;
	case VK_NUMPAD5: text = "Numpad 5"; break;
	case VK_NUMPAD6: text = "Numpad 6"; break;
	case VK_NUMPAD7: text = "Numpad 7"; break;
	case VK_NUMPAD8: text = "Numpad 8"; break;
	case VK_NUMPAD9: text = "Numpad 9"; break;

		// Math keys
	case VK_MULTIPLY: text = "*"; break;
	case VK_ADD: text = "+"; break;
	case VK_SEPARATOR: text = ""; break;
