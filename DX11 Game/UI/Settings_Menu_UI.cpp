...
void Settings_Menu_UI::Initialize( ID3D11Device* device, ID3D11DeviceContext* contex, ConstantBuffer<CB_VS_matrix_2D>* cb_vs_matrix_2d, std::shared_ptr<Fonts> fonts )
{
...
{
	// Update file
	if ( SettingsButtons[SettingsButtonCount].Function( LoadedTextMap["Button_Accept"], AcceptButton, { _SizeOfScreen.x / 9, _SizeOfScreen.y / 9 },
		XMFLOAT2{ static_cast<float>( _SizeOfScreen.x * 0.89 ) ,  static_cast<float>( _SizeOfScreen.y * 0 ) }, DirectX::Colors::Black, _MouseData ) )
	{
