...
public:
	...
	virtual void Inizalize(ID3D11Device* device, ID3D11DeviceContext* contex, ConstantBuffer<CB_VS_matrix_2D>* _cb_vs_matrix_2d)=0;
	virtual void Update()=0;
	virtual void BeginDraw(VertexShader& vert, PixelShader& pix)=0;
